...
* \brief           Ouvre une simple fenêtre Windows et dessine un texte en déplacement avec une fonte spéciale générée en texture mapping (une tête de mort).
...
* \param      text          un pointeur sur la chaîne de caractères à imprimer
* \return     GLvoid        un void OpenGL.
*
*/
...
int LoadGLTextures()									// Load Bitmaps And Convert To Textures
{
	...
	if (!NeHeLoadBitmap3("../../Data/Lights.bmp", texture))		// Load The Bitmap
		return FALSE;
