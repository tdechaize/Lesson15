# Lesson15
Lesson15 OpenGL (from NeHe).

Vous trouverez dans le sommaire ci-dessous toutes les explications utiles pour générer cette application illustrant l'usage d'OpenGL
(en provenance du site NeHe) : Texturemapped Outline Font.
...
En résumé, voci un descriptifs succinct de ce que pouvez y trouver :

## OpenGL Tutorial #15.

Project Name: Jeff Molofee's OpenGL Tutorial

Project Description : Texturemapped Outline Font Tutorial
